...
```{r, echo=FALSE, fig.cap="The cumulative points Hamilton got during the seasons 2015-2019."}
...
```{r, echo=FALSE, fig.cap="Histograms of mean score with mean lines for limited and unlimited sample."}
...
```{r, echo=FALSE,fig.cap="Density plot of mean score with mean lines for limited and unlimited sample."}
...
-   Bulk ESS of the hierarchical model: `r round(mean(hier_monitor[["Bulk_ESS"]][1:113]),2)`
-   Tail ESS of the hierarchical model: `r round(mean(hier_monitor[["Tail_ESS"]][1:113]),2)`
...
Below are the traceplots 

```{r, echo=FALSE, fig.cap="Trace plot of the hierarchical model."}
traceplot(
  hier_fit,
  nrow=4,
  inc_warmup=FALSE,
...
```{r, echo=FALSE, fig.cap="Trace plot of the nonhierarchical model."}
traceplot(
  pool_fit,
  nrow=3,
  inc_warmup=FALSE,
