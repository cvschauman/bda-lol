...
Since the values of this normal distribution,

```{r}
d = density(ham_extracted26)
plot(d, xlim=c(0,28), main="Density plot of the mean hamilton the next season")
...
ham_pool_extracted26 = density(ham_pool_extracted26)

plot(
  ham_pool_extracted26, 
  xlab="",
  ylab="Density",
  main="Predictive distribution of the mean hamilton the next season", 
  col="black",
