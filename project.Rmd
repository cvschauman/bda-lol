...
For our parameters $\mu$ and $\sigma$ we used weekly informative priors based on the appearance of the data. The final priors chosen where the following:
...
r_pool_mean = mean(summary(pool_fit)$summary[1:108,10])
